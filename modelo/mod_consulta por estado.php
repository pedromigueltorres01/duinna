...
SELECT h.codigo,h.nacionalidad,h.cedula,h.primer_nombre,h.primer_apellido,h.fecha_naci,h.edad,h.sexo,h.estado_civil,h.telefono,h,correo,
h.indique_trabajo,
...
edu.escolarizado,edu.sabe_leer,edu.institucion,edu.ultimo_grado_apro,edu.turno,edu.nivel_educativo,h.estatus
 ...
 datos_educativos_nna as edu ON edu.codigo=h.codigo and  u.estado = '$estado'  WHERE   
...
require_once('../vista/mostrar_consulta_porEstado.php');
