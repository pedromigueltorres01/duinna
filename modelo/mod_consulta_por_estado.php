...
SELECT 						h.codigo,
						...
						p.primer_nombre,p.primer_apellido,p.parentesco,p.nacionalidad1,p.cedula,p.telefono,p.correo,p.trabajo
						 ...
						 and  a.estatus ='ACTIVO' and  edu.estatus ='ACTIVO' and asig.asignar_programa='$programa' and u.estado='$estado';
  ");
       if (!$consul_general) {
	...
	$perfil= $_SESSION['perfil']; 
                 ...
                 if( $perfil == 'ADMINISTRADOR'){
                  ...
                  require("../vista/mostrar_consulta_porEstado_coor.php");
                  exit();

              }else{
                   require("../vista/mostrar_consulta_porEstado_promo.php");
                   exit();
