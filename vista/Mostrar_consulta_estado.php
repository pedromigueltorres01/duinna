...
<ul class="menu">
    ...
    <li><a href="../vista/preguntadecedulapadre.php">REGISTRO NNA </a></li> <li><a href="#">GESTIONAR NNA </a>
     ...
     <li><a href="#">REPORTES</a>
        <ul>
             <li class="li"><a href="../vista/Reportes_Estado.php">CONSULTA DE ESTADOS</a></li>
             <li class="li"><a href="../vista/Reporte_General_Estado.php">CONSULTA NACIONAL</a></li>
             
             <li class="li"><a href="../vista/Reportes_Programa.php">REPORTES POR PROGRAMAS</a></li>
             <li class="li"><a href="../vista/Reportes_General_Programa.php">REPORTES GENERAL POR PROGRAMAS</a></li>
...
<input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
  ...
  <table  style="margin-left: 0%;" width="100%" border="1" cellpadding="34" cellspacing="0" bordercolor="#2E2E2E" id="Exportar_a_Excel" style="border-collapse:collapse; margin: 0px; padding: 30px;">
        <tr>                
                              <td colspan="34"><h2><p style="color: #01DFD7; font-size: 150%; margin: 0px; f; " >DUINNA de</p></h2></td>
        </tr> 
  ...
  $i=1;
                  ...
                  while($consulta=pg_fetch_row($consul_generalEstado) ) {
                  ...
                  <tr  >
                           <td style="padding: 15px;"><?php echo "$i"." "; ?> </td>
                            ...
                            <td style="padding: 15px;"><?php echo $consulta['32']." "."<br>"; ?></td>
