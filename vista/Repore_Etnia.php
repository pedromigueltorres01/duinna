...
<head>
	<meta charset="utf-8">
	<title>Reportes Grupos Etnicos</title>
...
<div style="">
      <div style="">
            <h1 style="color: #2ECCFA; margin-left: 38%;font-size: 3em; margin-top:1.5%; ">Reporte por Etnia</h1>
      </div>



<div>
<form action="../controlador/con_Reporte_Etnia.php" method="post">
<input class='btn btn-lg btn-primary btn-block btn-signin' style="margin-left: 45%; margin-top: 4%" size="40" type="submit" name="RealizarReporte" value="Realizar reporte">   <!REALIZAR REPORTE>
</form>
</div>
</div>
