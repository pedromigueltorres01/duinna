...
<div style="">
      <div style="">
            <h1 style="color: #2ECCFA; margin-left: 0%;font-size: 3em; margin-top:1.5%; ">Reporte por Etnia</h1>
      </div>
...
<footer style=" position: absolute;margin-top: 1%; background-color: #999; height: 20px; width: 96.9%;"> 
