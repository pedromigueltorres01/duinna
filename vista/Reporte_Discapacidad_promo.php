...
<input class='btn btn-lg btn-primary btn-block btn-signin' style=" margin-top: 4%" size="40" type="submit" name="RealizarReporte" value="Realizar reporte">   <!REALIZAR REPORTE></form>
</center>
</div>
