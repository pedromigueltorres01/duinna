...
<body>
<div style="margin-top: 12em;color: #2ECCFA;">
<h1><center>Reporte por Programa</center></h1>
</div>

<br>

 <div style="  margin: 3px;padding: 0px;  margin-left: 0%; width:100%; height: 300px; ">
  <form  method="post" action="../controlador/con_reporte_Programa.php">
         <div style="margin-left: 0%; margin-top: 3em;">
                <select name="Programa" id="usuario"  style=" padding: 0.3%; width: 20%;  margin: 5px;  ">
                        ...
                        <option value="PROGRMA NACIONAL DE LECTURA SOMBRERO DE LA Ñ" required="complete este campo">Programa Nacional de Lectura Sombrero de la Ñ </option>
        ...
        <div style="  width: 100%; margin-top: 5em;">
          <input class='btn btn-lg btn-primary btn-block btn-signin'  size="40" type="submit" name="RealizarReporte" value="Realizar reporte"> 
        </div>
                        </BR></form>
  </div>
