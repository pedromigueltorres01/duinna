...
<body>
  <header>
    ...
    height: 189px;"></head>
     ...
     <form action="actividadesrecreativas2.php" method="post">
                  <!INCLUIR>
...
document.getElementById('culturaprac').value=x;
}
</script>
 <font style="margin-left: 250px" size="4"> <b>¿Practica cultura?</b> </font>
    <select style="margin-left: 24px" id="practicacultura" name="practicacultura" required="complete este campo" onChange="mostrar(this.value);">
        <option value="" required="complete este campo" >Seleccione</option>
        <option value="culturasi" required="complete este campo" >Si</option>
        <option value="culturano" required="complete este campo" >No</option>
    
     </select>
</br></br>
<font style="margin-left: 250px" size="4">¿Que cultura practica?</font>
<input style="margin-left: 23px" size="40" type="tex"placeholder="Indique la cultura" name="culturaprac" id="culturaprac" value="" required="complete este campo" pattern="{2,}" >

<select name="praccultura" onchange="mostrarValor(this.value);">
