...
<div style="">
      <div style="">
            <h1 style="color: #2ECCFA; margin-left: 0%;font-size: 3em; margin-top:1.5%; ">Reporte Familiar</h1>
      </div>

      <div>
            <section class="webdesigntuts-workshop">
              <form style= "margin-left:0%; margin-top: 7%" id="searchform" action="../controlador/con_reporte_familiar.php" method="POST">        
                <input type="search" name="id_representante" placeholder="Buscar Representante..." required="complete este campo">         <!buscador>
