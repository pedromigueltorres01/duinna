...
<body>
	<center><h1><p style="color: #01DFD7; font-size: 150%; margin: 0px;  " >Modificar Usuario</p></h1></center></br>
	<center><table>
   

		<form action="../controlador/con_buscar_usuario_modificar.php" method="POST">
      
			 &nbsp;  <input type="text" name="usuario" type="number" placeholder="Cédula"  required pattern="[0-9]{6,}"  size="20" maxlength="100"><br><br>
        <input class='btn btn-lg btn-primary btn-block btn-signin' type="submit" name="buscar" value="buscar">
