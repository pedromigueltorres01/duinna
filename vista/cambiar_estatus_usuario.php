...
<body>
  <center><h1><p style="color: #01DFD7; font-size: 150%; margin: 0px;  " >Eliminar Usuario</p></h1></center></br>
	<center><table>

		<form action="../controlador/desactivar_usuario.php" method="POST">
			 &nbsp;<input style="color:#DF0101"  type="text" name="usuario" placeholder="Introduzca la Cédula" >
			 <br><br>
       <center>
<input class='btn btn-lg btn-primary btn-block btn-signin' type="submit" name="Eliminar" value="Eliminar">
				</center>
			</form>
