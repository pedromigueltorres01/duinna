...
<ul class="menu">
    ...
    <li><a href="../vista/preguntadecedulapadre.html">REGISTRO NNA </a></li> 
...
<body>
  <center><h1 style="color: #2ECCFA;">Consultar Usuarios Eliminados</h1>
	</center>
    </div>
	<table>
		<tr> <td>
...
<form action="../controlador/validar_usuarios_inactiovs.php" style="margin-left: 0%" method="POST">
				<input    type="text" name="usuario"  required placeholder="Cédula">
				
				<input  class='btn btn-lg btn-primary btn-block btn-signin' type="submit" value="Consulta especifica">
			</form></table>

			</br></br></br>
		</td></center>
		<td> <center>
			<form action="../controlador/consul_general_usu_inactivos.php" method="POST">
				 <input  class='btn btn-lg btn-primary btn-block btn-signin' type="submit" name="consulta_general" value="Consulta General">
			</form></center>  </td>
...
<div style="margin-top: 35%; "><footer id="footer2" style="background-color: #999;"> <address style="margin-left: 30%;"> <font style="margin:0px; padding: 0px; width: 100%;" color="white"><center></b> Intranet Idena - Copyletf2015 Instituto Anonimo Consejo Nacional de Derechos de Niñas, Niños y Adolescentes &copy; <br>
