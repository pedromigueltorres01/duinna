...
<html>
  <div style="">
      <div style="">
      <h1 style="color: #2ECCFA; margin-left: 38%; font-size: 3em; margin-top:2.2%; ">Habilitar NNA</h1>
      </div>


      <div style= "margin-top: 1%;">
        <section  class="webdesigntuts-workshop">
                 <form style="margin-left:38.5%;" id="searchform" action="../controlador/con_gestionar_nna.php" method="POST">      
