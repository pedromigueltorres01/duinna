...
<body>
       ...
       <table  style="margin-left: 0%" width="100%" border="1" cellpadding="12" cellspacing="0" bordercolor="#666666" id="Exportar_a_Excel" style="border-collapse:collapse;">
                    <tr>
                    	<td colspan="14"><h2>Consulta Específica</h2></td>
                    </tr>
                 <tr bgcolor="#913B3B"> 
...
$datas=$_SESSION['dat'];
 ...
 <script type="text/javascript">
          alert('El NNA se encuentra ACTIVO, desea Inhabilitar?');
        </script>
...
<input class='btn btn-lg btn-primary btn-block btn-signin' style="margin-left: 30px; margin-top: 4%" size="40" type="submit" name="modificarNna" value="Inhabilitar">   
</form></td>
