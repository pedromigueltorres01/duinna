...
<body>
 ...
 <div style="">
        <div style=" margin-top: 10em;  ">
              <h1 style="color: #2ECCFA; font-size: 3em; margin-left: 38%;  ">Modificar NNA</h1>

        </div>
        <div style= " margin-top: 1%;  ">
                  <section  class="webdesigntuts-workshop">
                  
                 <form style="margin-left:38.5%;"  id="searchform" action="../controlador/Con_Buscar_nna.php" method="POST">      
