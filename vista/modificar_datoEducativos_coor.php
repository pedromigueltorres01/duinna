...
<input style="margin-left: 23px" size="40" type="text"placeholder="Nombre de la institución" name="institucion" id="institucion" value="" required="complete este campo"  >
