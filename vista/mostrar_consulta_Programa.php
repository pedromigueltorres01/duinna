...
<head>
	<meta charset="utf-8">
	<title>Reporte por Discapacidad</title>
...
<input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
  ...
  <table  style="margin-left: 0%" width="100%" border="1" cellpadding="16" cellspacing="0" bordercolor="#666666" id="Exportar_a_Excel" style="border-collapse:collapse;">
    <tr>
      <td colspan="17"><h2><p style="color: #01DFD7; font-size: 150%; margin: 0px; f; " > Reporte por Programa </p></h2></td>
    </tr>
<tr bgcolor="#8A0808" id="fija">
    ...
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Correo</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Estatus</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Progrma</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Fecha de Incorporación</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Nombre-Ccpi-Código-Grupo-Brigada</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Lugar de funcionamiento</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Registrado por</td>
    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">cedula</td>
</tr> 
     <?php
     $i=1;   while ($row = pg_fetch_assoc($consul_general)) {
     ?>
<tr>
        ...
        <td style="padding: 15px;"> <?php echo $row['sexo']; ?></td>
        <td style="padding: 15px;"> <?php echo $row['telefono']; ?></td>
        <td style="padding: 15px;"> <?php echo $row['correo']; ?></td> 
        <td style="padding: 15px;"> <?php echo $row['estatus']; ?> </td> 
        <td style="padding: 15px;">  <?php echo $row['asignar_programa'];?></td>
        <td style="padding: 15px;"> <?php echo $row['fecha_incorporacion']; ?></td>
        <td style="padding: 15px;"> <?php echo $row['nombre_ccpi_grupo_codigo']; ?></td>
        <td style="padding: 15px;"> <?php echo $row['lugar_funcionamiento']; ?></td>
        <td style="padding: 15px;"> <?php echo $row['promotor'];?></td>
        <td style="padding: 15px;"> <?php echo $row['cedulapromotor']; ?></td>
</tr><?php
           $i++;        
        }
