...
<input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
	...
	<center>	
               	   <table  style="margin-left: 3%" width="50%" border="1" cellpadding="10" cellspacing="0" bordercolor="#666666" id="Exportar_a_Excel" style="border-collapse:collapse;">
               	   	<tr bgcolor="#FBEFF2"><td colspan="6"><h2>Consulta Específica</h2></td></tr>
      ...
      <tr>
          <td style="color: #000000; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;"> <b><?php echo $arr["0"]."\n"; ?></b></td> 
          <td style="color: #000000; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;"><b><?php echo $arr["1"]."\n"; ?></b></td>
          <td style="color: #000000; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;"><b><?php echo $arr["2"]."\n"; ?></b></td>
          <td style="color: #000000; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;"><b><?php echo $arr["3"]."\n"; ?></b></td>
          <td style="color: #000000; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;"><b><?php echo $arr["4"]."\n"; ?></b> </td>
      </tr>
					</table>
