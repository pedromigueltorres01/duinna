...
<head>
	<meta charset="utf-8">
	<title>Consultar Usuarios Eliminados</title>
...
<input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
	...
	<center>	
               	    <table  style="margin-left: 3%" width="50%" border="1" cellpadding="10" cellspacing="0" bordercolor="#666666" id="Exportar_a_Excel" style="border-collapse:collapse;">
               	   	<tr>
                      <td colspan="6"><h2><p style="color: #FF8000; font-size: 150%; margin: 0px; f; " >Usuario Eliminado</p></h2></td>
                    </tr>
               		<tr bgcolor="#FF0000" id="fija"> 
                    ...
                    <td style="color: white; font-family:arial, Times New Roman, helvetica; font-size: 75%; padding: 15px;">Estatus</td>
                 	<tr>
                    <td style="padding: 15px; color: #B40404;"><?php echo $arr["0"]; ?></td> 
                    <td style="padding: 15px; color: #B40404;"><?php echo $arr["1"]; ?></td>
                    <td style="padding: 15px; color: #B40404;"><?php echo $arr["2"]; ?></td>
                    <td style="padding: 15px; color: #B40404;"><?php echo $arr["3"]; ?> </td>
                    <td style="padding: 15px; color: #B40404;"><?php echo $arr["4"]; ?> </td>
                    <td style="padding: 15px; color: #B40404;"><?php echo $arr["5"]; ?> </td>
