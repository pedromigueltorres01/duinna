...
<font style="margin-left: 14em" size="4"><b>Número de Cédula</b></font>
<input style="margin-left: 97px" size="40" type="tex" placeholder="Indique la Cédula"  name="cedula" required pattern="[0-9]{6,}" title="Solo números min. 6 digitos" required="complete este campo" >
...
<br>
<br>
<input class='btn btn-lg btn-primary btn-block btn-signin' style="margin-left: 30em" type="button" onclick="history.back()" name="Atrás" value="Atrás">
<input class='btn btn-lg btn-primary btn-block btn-signin' style="margin-left: 30em" size="40" type="submit" name="incluir" value="Enviar">
...
margin-top: 20em;">
<footer id="footer2" style="background-color: #999"> <address style="margin-left: 0em;"> <font color="white"><center></b> Intranet Idena - Copyletf2015 Instituto Anonimo Consejo Nacional de Derechos de Niñas, Niños y Adolescentes &copy; <br>
