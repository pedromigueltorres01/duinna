...
<ul class="menu">
    ...
    <li><a href="#">GESTIONAR NNA </a>
     ...
     <li><a href="#">REPORTES </a>
        <ul>
             <li><a href="../vista/Reportes_Estado.phpphp">CONSULTA DE ESTADOS </a></li>
...
<div style="">
      ...
      <div>
          ...
          <center><input class='btn btn-lg btn-primary btn-block btn-signin' style="margin-left: 0%; margin-top: 4%" size="40" type="submit" name="RealizarReporte" value="Realizar reporte"></center>   <!REALIZAR REPORTE>
          </form>
      </div>
</div>
